...
NAMES = {
    ...
    "091160": "반도체 (KODEX)",
    "122630": "KOSPI200 레버리지 (KODEX 2x)",
    "233740": "코스닥150 레버리지 (KODEX 2x)",
    "114260": "국고채 3년 (안전자산)",
    "153130": "단기채권 (현금성)",
...
STRATEGIES: dict[str, dict] = {
    ...
    "kr_leverage_alt": {
        "name": "레버리지 분산 + 대체자산", "profile": "공격",
        "description": "'글로벌 분산+대체자산'의 국내 지수를 2배 레버리지로 교체한 공격형. "
                       "금·원유가 상관을 낮추고 약세 시 국고채로 도피해 레버리지 낙폭을 억제. "
                       "단기(1/3/6개월) 모멘텀 상위 3개",
        "type": "dual",
        "risk": ["122630", "233740", "133690", "143850", "132030", "130680"],
        "safe": "114260", "cash_proxy": "153130", "top_n": 3,
        "lookbacks": (21, 63, 126),
        "min_seed": 1_000_000,
    },
...
TAX_FREE_TICKERS = {
    ...
    # 국내 지수 레버리지 ETF — 국내주식·장내파생상품(코스피200/코스닥150 선물)의
    # 매매차익이 비과세라 ETF 매매차익도 비과세. 해외지수·원자재 레버리지와 다르다.
    "122630",  # KODEX 레버리지 (KOSPI200 2x)
    "233740",  # KODEX 코스닥150 레버리지 (2x)
